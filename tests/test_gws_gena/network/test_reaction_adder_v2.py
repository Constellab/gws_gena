...
from gws_gena import (ReactionAdder, TransformerEntityIDTable)
...
class TestReactionAdder(BaseTestCaseUsingFullBiotaDB):
    ...
    def test_reaction_ec_adder(self):
        ...
        net = NetworkImporterV2.call(File(path=os.path.join(data_dir, "toy", "toy.json")), params={"add_biomass" : True})
