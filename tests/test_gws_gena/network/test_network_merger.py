...
from gws_gena import DataProvider, NetworkImporter, NetworkMerger
...
class TestMerge(BaseTestCaseUsingFullBiotaDB):
    def test_merger(self):
        ...
        tester = TaskRunner(
            params={}, inputs={"network_1": net1, "network_2": net2}, task_type=NetworkMerger
        )
        outputs = tester.run()
        ...
        self.assertTrue("RHEA_66592_4_2_99_18" in str(net_merged.reactions))
        self.assertTrue("RHEA_64596_2_4_1_370" in str(net_merged.reactions))

        self.assertTrue("RHEA_66592_4_2_99_18" in str(net2.reactions))
        self.assertTrue("RHEA_64596_2_4_1_370" in str(net2.reactions))

        self.assertTrue("RHEA_66592_4_2_99_18" not in str(net1.reactions))
        self.assertTrue("RHEA_64596_2_4_1_370" not in str(net1.reactions))
