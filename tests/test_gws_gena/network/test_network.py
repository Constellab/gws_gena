...
class TestNetwork(BaseTestCaseUsingFullBiotaDB):
    def test_network_import(self):
        ...
        file_path = DataProvider.get_test_data_path("small_net/small_net.json")
        ...
        self.print(net.loads(json_data))
        self.print(net.compounds)
        ...
        # export as table
        csv = net.to_csv()
        file_path = DataProvider.get_test_data_path("small_net/small_net.csv")
    ...
    def test_network_import_bigg_file(self):
        file_path = DataProvider.get_test_data_path("ecoli/ecoli.json")
    ...
    def test_network_import_file_with_metabolite_biomass(self):
        file_path = DataProvider.get_test_data_path("ecoli/ecoli_with_biomass_metabolite.json")
