...
from gws_gena import DataProvider, TransformerBiomassReactionTable
...
class TestTransformerBiomassReactionTable(BaseTestCaseLight):
    def test_transformer_biomass_reaction_table_(self):
        ...
        biomass_reaction_table = TableImporter.call(
            File(path=os.path.join(data_dir, "./recon/recon_biomass.csv")),
        ...
        self.assertEqual(
            biomass_reaction_table.get_column_names(),
            ["entity", "chebi_id", "biomass", "Protein", "DNA", "RNA"],
        )
