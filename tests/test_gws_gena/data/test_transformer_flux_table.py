...
from gws_gena import DataProvider, TransformerFluxTable
...
class TestTransformerFluxTable(BaseTestCaseLight):
    def test_transformer_phenotype_table_(self):
        ...
        flux_table = TableImporter.call(
            File(path=os.path.join(data_dir, "toy/ctx_data/toy_ctx_data_1.csv")),
        ...
        flux_table = TableImporter.call(
            File(path=os.path.join(data_dir, "data/fluxTableMulti.csv")),
            params={"index_column": -1},
        )
