...
class TestKEGGVisualisation(BaseTestCase):
    def test_kegg_visualisation(self):
        ...
        # load genes:
        list_genes = File(DataProvider.get_test_data_path("kegg/genes_human.txt"))
        ...
        list_genes = TableImporter.call(
            File(path=DataProvider.get_test_data_path("kegg/genes_human.txt")),
        ...
        # load genes:
        list_genes = File(DataProvider.get_test_data_path("kegg/genes_human_one_fold_change.txt"))
        # create the TaskRunner
        runner_kegg_visualisation = TaskRunner(
            task_type=KEGGVisualisation,
            inputs={"list_genes": list_genes},
        ...
        list_genes = File(DataProvider.get_test_data_path("kegg/genes_human_two_fold_change.txt"))
        # create the TaskRunner
        runner_kegg_visualisation = TaskRunner(
            task_type=KEGGVisualisation,
            inputs={"list_genes": list_genes},
        ...
        list_genes = File(
            DataProvider.get_test_data_path("kegg/gene_Ensembl_human_with_two_fc.txt")
        )
        # create the TaskRunner
        runner_kegg_visualisation = TaskRunner(
            task_type=KEGGVisualisation,
