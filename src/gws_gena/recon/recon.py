...
@task_decorator(
    "DraftRecon001",
    human_name="Draft recon",
    short_description="Draft network reconstruction",
    ...
    config_specs = ConfigSpecs(
        {
            "unique_name": StrParam(
                default_value=StringHelper.generate_random_chars(4),
                human_name="Network name",
                short_description="The unique name of the network. Required to uniquely identify taxa in microbial communities",
            ),
            "tax_id": StrParam(
                default_value="",
                human_name="Taxonomy ID",
                short_description="The NCBI taxonomy id. For example: `tax_id = 562` for E. Coli",
            ),
            "tax_search_method": StrParam(
                default_value="bottom_up",
                allowed_values=["none", "bottom_up"],
                human_name="Taxonomy search method",
