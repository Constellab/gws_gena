...
class NetworkImporterV2(ResourceImporter):
    ...
    def load_network(self, data = None, replace_unknown_compartments: bool =None,
    biomass_metabolite_id_user: str = None, add_biomass: bool = False ) -> 'NetworkCobra' :
            ...
            if rxn_data.get("enzymes", []):
                ...
                if ec_number:
                    if isinstance(ec_number, list):
                        ...
                        ec_numbers = [ec_number]
                    rxn_data['ec_numbers'] = ec_numbers #TODO : regarder pour mettre dans notes certainement
