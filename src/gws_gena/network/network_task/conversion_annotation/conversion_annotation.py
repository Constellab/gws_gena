...
class ConvertAnnotation(Task):
    ...
    def run(self, params: ConfigParams, inputs: TaskInputs) -> TaskOutputs:
        ...
        shell_proxy.run(f"python3 {self.script_conversion_annotation} {input_model.path} {output_path} {metabolites_id} {metabolites_name} {reaction_id} {reaction_name} {results_path}", shell_mode = True)
