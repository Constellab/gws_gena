...
@task_decorator(
    "NetworkMerger",
    human_name="Network merger",
    short_description="Merge two networks",
...
class NetworkMerger(Task):
    ...
    input_specs = InputSpecs(
        {
            "network_1": InputSpec(
                Network, human_name="Network 1", short_description="The first network"
            ),
            "network_2": InputSpec(
                Network, human_name="Network 2", short_description="The second network"
            ),
        }
    )
