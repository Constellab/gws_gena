    ...
    def run(self, params: ConfigParams, inputs: TaskInputs) -> TaskOutputs:
        ...
        if params["organism"]:
            if params["name_organism"]:
                raise Exception(
                    "You have entered an organism ID and selected an organism name, please choose between the two.")
            else:
                id_organism: str = params["organism"]
            ...
            raise Exception(
                "You must either enter an organism ID or select the name of an organism.")
