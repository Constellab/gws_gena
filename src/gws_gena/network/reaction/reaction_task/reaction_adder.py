...
@task_decorator(
    "ReactionAdder",
    human_name="Reaction adder",
    short_description="Add a list of reactions to a network",
...
class ReactionAdder(Task):
    ...
    input_specs = InputSpecs(
        {
            "network": InputSpec(
                Network, human_name="Network", short_description="Network to complete"
            ),
            "reaction_table": InputSpec(
                Table,
                human_name="Table of EC numbers or IDs",
                short_description="The table of reactions to add",
            ),
        }
    )
    output_specs = OutputSpecs(
        {
            "network": OutputSpec(
                Network, human_name="Network", short_description="The network after completion"
            ),
        }
    )
