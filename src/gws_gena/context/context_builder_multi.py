...
from .helper.context_builder_helper_multi import ContextBuilderHelperMulti


@task_decorator("ContextBuilderMulti", human_name="Context builder Multi",
                short_description="Build a context for a metabolic network using a flux table")
class ContextBuilderMulti(Task):
    """
    ContextBuilder Task
    ...
    def run(self, _: ConfigParams, inputs: TaskInputs) -> TaskOutputs:
        ...
        helper = ContextBuilderHelperMulti()
