...
class GenerationMultiSimulations(Task):
    ...
    def run(self, params: ConfigParams, inputs: TaskInputs) -> TaskOutputs:
        ...
        def create_simulated_data(number_simulations: int, experimental_data: pd.DataFrame):
        ...
        simulated_data = create_simulated_data(number_simulations= number_simulations, experimental_data=experimental_data)
        ...
        def generation_simulations_context(context: pd.DataFrame, number_simulations: int):
        ...
        #Generate data
        simulations_generated = generation_simulations_context(context = simulated_data, number_simulations=number_simulations)
