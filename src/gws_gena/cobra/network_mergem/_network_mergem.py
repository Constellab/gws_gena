...
results = mergem.merge([model,model2], set_objective= keep_objective, exact_sto= exact_stoichiometry, use_prot=use_proton, extend_annot=add_annotations, trans_to_db= trans_to_db)
