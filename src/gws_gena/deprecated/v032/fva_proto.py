...
from .dep_fva.fva import FVA


@task_decorator("FVAProto_001", human_name="Deprecated FVA protocol",
                short_description="Flux variability analysis protocol", hide=True, deprecated_since='0.4.0',
                deprecated_message="Use new version of FVAProto")
