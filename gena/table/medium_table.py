...
class MediumTable(CSVData):
    ...
    * The next columns are:
    ...
    @classmethod
    def _import(cls, *args, chebi_column_name:str="chebi_id", **kwargs) -> 'MediumTable':
        """ 
...
class MediumImporter(CSVImporter):
    ...
    config_specs = {
        **CSVImporter.config_specs,
        'chebi_column_name': {"type": 'str', "default": MediumTable.CHEBI_COLUMN_NAME, "description": "The CheBI ID column name"},
    }
