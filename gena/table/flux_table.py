...
class FluxImporter(CSVImporter):
    ...
    config_specs = {
        **CSVImporter.config_specs,
        'target_column_name': {"type": 'str', "default": FluxTable.TARGET_COLUMN_NAME, "description": "The name of the target column"},
        'lower_bound_column_name': {"type": 'str', "default": FluxTable.LOWER_BOUND_COLUMN_NAME, "description": "The name of the lower-bound column"},
        'upper_bound_column_name': {"type": 'str', "default": FluxTable.UPPER_BOUND_COLUMN_NAME, "description": "The name of the upper-bound column"},
        'confidence_score_column_name': {"type": 'str', "default": FluxTable.CONFIDENCE_SCORE_COLUMN_NAME, "description": "The name of the upper-bound column"},
    }
