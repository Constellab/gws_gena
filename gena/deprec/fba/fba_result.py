...
from ...fba.fba_result import FBAResult as BaseFBAResult, OptimizeResult

class FBAResult(File, BaseFBAResult):
    _content = None
    ...
    def __init__(self, *args, biomodel: BioModel=None, optimize_result: OptimizeResult = None, **kwargs):
        ...
        BaseFBAResult.__init__(self, *args, biomodel=biomodel, optimize_result=optimize_result, **kwargs)
